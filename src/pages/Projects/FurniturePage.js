  ...
  return (
    <ProjectLayout>
      <MotionStack spacing={2}>
        <SlideInImage src={`${process.env.PUBLIC_URL}/images/furniture1.png`} alt="furniture image1" imgSx={{ height: "30vw", objectFit: "contain" }} />
        ...
        <SlideInImage src={`${process.env.PUBLIC_URL}/images/furniture2.png`} alt="furniture image2" />
        ...
        <SlideInImage src={`${process.env.PUBLIC_URL}/images/furniture3.png`} alt="furniture image3" />
        ...
        <SlideInImage src={`${process.env.PUBLIC_URL}/images/furniture4.png`} alt="furniture image4" />
