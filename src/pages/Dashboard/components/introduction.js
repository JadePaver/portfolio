    ...
    return (<>
        ...
        >
            ...
            <Grid size={{ md: 12 }}>
                ...
                >
                    <Typography fontWeight={600} fontSize={{ xs: "1.5rem", lg: 56 }} color="secondary.main">
                        Introduction
                    </Typography>
                </motion.div>
                <motion.div
            ...
            <Collapse in={showMore} timeout={700} unmountOnExit>
                <Grid size={{ md: 12 }}>
                    <motion.div
                        ...
                        variants={textVariants}
                    >
                        <Typography fontWeight={600} fontSize={{ xs: "1.5rem", lg: 56 }} color="secondary.main" sx={{ mt: "2rem" }}>
                    ...
                    >
                        <Typography
                            variant="body2"
                            color="secondary.main"
                            sx={{ mt: "2rem", lineHeight: { xs: 1.5, lg: 1.75 }, fontSize: { xs: "0.75rem", lg: "1rem" }, textAlign: "justify" }}
                        >
                        ...
                        <Typography
                            variant="body2"
                            color="secondary.main"
                            sx={{ mt: "1.5rem", lineHeight: { xs: 1.5, lg: 1.75 }, fontSize: { xs: "0.75rem", lg: "1rem" }, textAlign: "justify" }}
                        >
                ...
                <Grid size={{ md: 12 }}>
                    ...
                    <motion.div
                        ...
                        variants={textVariants}
                    >
                        <Typography variant="body2" color="secondary.main" sx={{ mt: "1.5rem", lineHeight: { xs: 1.5, lg: 1.75 }, fontSize: { xs: "0.75rem", lg: "1rem" }, textAlign: "justify" }}>
