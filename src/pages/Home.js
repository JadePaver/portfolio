...
const MARQUEE = [
  ...
  { name: "Node.js", note: "Small services · daily driver" },
  { name: "MySQL", note: "Schemas and queries · daily driver" },
  { name: "Supabase", note: "Auth, storage and realtime data · production" },
  { name: "MUI", note: "Component system for React dashboards · daily driver" },
...
const MILESTONES = [
  {
    ...
    capsule: { label: "Self-directed", year: "Since 2016" },
    chapter: {
      eyebrow: "2016",
      title: "Self-directed since 2016",
      ...
      stats: [
        ...
        { label: "Paid work since", value: "2020", accent: true },
      ],
    },
  },
  {
...
const STACK = [
  { name: "Node.js", tier: 3, note: "Small services, scripts, build tooling" },
  { name: "REST APIs", tier: 3, note: "Contracts other developers build against" },
  ...
  { name: "Figma", tier: 3, note: "Design review and developer handoff" },
  { name: "MUI", tier: 3, note: "Component system behind the React dashboards" },
  ...
  { name: "PostgreSQL", tier: 2, note: "Moving my MySQL habits across" },
  { name: "Docker", tier: 2, note: "Local environments that match production" },
  { name: "CI/CD", tier: 2, note: "Automating the release steps I still do by hand" },
